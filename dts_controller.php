...
add_action( 'admin_init', array( 'DTS_Admin', 'load_plugin_textdomain' ), 1 );
...
// admin css ##
add_action( 'admin_footer', array( 'DTS_Admin', 'admin_css' ), 100000 );
// admin jQuery ##
add_action( 'admin_footer', array( 'DTS_Admin', 'admin_jquery' ), 100000 );
...
if ( !is_admin()) :
    ...
    add_action( 'admin_bar_menu', array ( 'DTS_Switcher', 'admin_bar_menu' ), 1000 );
